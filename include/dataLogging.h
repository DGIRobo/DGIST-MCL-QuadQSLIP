...
void init_save_data_leg(FILE* fid)
{
    ...
    fprintf(fid, "velRWr_ref, velRWr, velRWtheta_ref, velRWtheta, ");
...
void save_data_leg(const mjModel* m, mjData* d, StateModel_* state_model, vector<Eigen::VectorXd> Ctrl_data, FILE* fid, int leg_sensor_no)
{
    ...
    fprintf(fid, "%f, %f, %f, %f", state_model->velRW_ref[0], state_model->velRW[0], state_model->velRW_ref[1], state_model->velRW[1]);
