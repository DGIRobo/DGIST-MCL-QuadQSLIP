...
xlim([0,10]);
xlabel('time (sec)');
ylabel('FL theta pos (rad)');
legend('reference', 'real')

subplot(3,2,5);
plot(FL_Arr(:,1), FL_Arr(:,8), 'Color', 'b', 'LineWidth', 3);
hold on;
plot(FL_Arr(:,1), FL_Arr(:,9), 'Color', 'r', 'LineWidth', 3);
xlim([0,10]);
xlabel('time (sec)');
ylabel('FL r vel (m/s)');
legend('reference', 'real')
...
subplot(3,2,6)
plot(FL_Arr(:,1), FL_Arr(:,10), 'Color', 'b', 'LineWidth', 3);
hold on;
plot(FL_Arr(:,1), FL_Arr(:,11), 'Color', 'r', 'LineWidth', 3);
xlim([0,10]);
xlabel('time (sec)');
ylabel('FL theta vel (rad/s)');
legend('reference', 'real')